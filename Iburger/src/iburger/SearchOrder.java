...
public class SearchOrder extends javax.swing.JFrame {
    ...
    public SearchOrder(IburgerCollection iburgerCollection) {
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnSearchOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(42, 42, 42)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnSearchOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(57, 57, 57))
        );
    ...
    private void btnSearchOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchOrderActionPerformed
        ...
        Iburger iburger = iburgerCollection.searchOrderId(searchId);
        if (iburger == null) {
            JOptionPane.showMessageDialog(this, "This Id Not Available");
        }else{
            txtName.setText(iburger.getName());
            txtNumber.setText(iburger.getNumber());
            txtQty.setText(iburger.getQty()+"");
            txtPrice.setText(iburger.getPrice()+"");
        }
